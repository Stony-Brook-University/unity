<?php include("header.php"); ?>				
	...
	<div id="main-content">
		...
		<div class="section three-cards">
			...
			<div class="card card-color light-red">
				<div class="swatch background-light-red">.background-light-red</div>
				Light Red (.light-red)
			</div>	

			<div class="card card-color dark-red">
				<div class="swatch background-dark-red">.background-dark-red</div>
				Dark Red (.dark-red)
			</div>	

			<div class="card card-color gray">
				<div class="swatch background-gray">.background-gray</div>
				Gray
			</div>	

			<div class="card card-color light-gray">
				<div class="swatch background-light-gray">.background-light-gray</div>
				Light Gray
			</div>	

			<div class="card card-color dark-gray">
				<div class="swatch background-gray">.background-dark-gray</div>
				Dark Gray
			</div>	

			<div class="card card-color blue">
				<div class="swatch background-blue">.background-blue</div>
				Blue
			</div>	

			<div class="card card-color green">
				<div class="swatch background-green">.background-green</div>
				Green
			</div>	

			<div class="card card-color Black">
				<div class="swatch background-black">.background-black</div>
				Black
			</div>	
	...
	<div class="section">
		...
		<div class="examples">
			...
			<div class="examples-example">
				...
				<div class="examples-example">
					<?php echo htmlspecialchars('<h1>Heading Text One</h1>'); ?>
				</div>

				<div class="examples-example">
					<?php echo htmlspecialchars('<h3>Heading Text Three</h3>'); ?>
				</div>

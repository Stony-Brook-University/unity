...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
	  ...
	  styleguide: {
		  files: ['sass/{,**/}*.scss', 'images/{,**/}/*', 'local-images/{,**/}*', 'javascripts/{,**/}*.js', 'fonts/{,**}/**'],
	  ...
	  styleguide: {
	   ...
	   //Files to look for and move to the destination
        files: [  
...

		  {
		  	...
		  	cwd: 'fonts',
		  	src: ['**'],
		  	dest: 'styleguide/stylesheets/fonts'
		  }
        ]
      },
	   ...
	   //Files to look for and move to the destination
        files: [  
		  ...
		  cwd: 'stylesheets',
		  src: ['**'],
		  dest: 'd:/git/kerrinpernic/docroot/sites/all/themes/custom/unity/stylesheets'
		  }
        ]
      },
	  ...
	  sbucommons: {
	   ...
	   //Files to look for and move to the destination
        files: [  
		  ...
		  cwd: 'stylesheets',
		  src: ['**'],
		  dest: 'd:/git/sbucommons/docroot/sites/all/themes/custom/unity/stylesheets'
		  }
        ]
      },
